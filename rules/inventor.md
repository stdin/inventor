...
4. Push past incremental: combine, generalize, or escalate a candidate until it would surprise someone who knows the space. A candidate must name a technical state machine, data representation, or algorithm, not just a desirable outcome.
